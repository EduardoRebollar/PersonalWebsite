 ...
 *
 * Lite-mode logic:
 *   - Auto: enabled when WebGL2 is missing, viewport is mobile, GPU tier ≤ 1,
...
function computeAutoLite(params: {
  ...
  return !params.hasWebGL2 || params.isMobile || params.gpuTier <= 1 || params.reducedMotion;
}
...
export const useSceneStore = create<SceneState>((set) => ({
  ...
  setReducedMotion: (reducedMotion) =>
    set((state) => {
      ...
      return {
        reducedMotion,
        liteMode: computeAutoLite({ ...state, reducedMotion }),
      };
    }),
