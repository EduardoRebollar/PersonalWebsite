  ...
  return (
    <footer className="relative z-10 border-t border-hairline bg-base/40 py-3 backdrop-blur-sm">
      <Container className="flex flex-col items-center justify-between gap-3 sm:flex-row sm:items-center">
        <p className="text-center font-mono text-[11px] tracking-wider text-fg-mute uppercase sm:text-left">
          <span className="text-[14px] align-middle">©</span> {year} · Designed &amp; Built With <span className="heart-float text-red-500">❤️</span> By {site.name} · {site.location}
        </p>
