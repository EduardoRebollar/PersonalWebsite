 ...
 * beat of the entrance: its delay (4.4s) lands it *after* the CTA cascade has
 * finished (CTAs start at delayChildren 3.6 + stagger, settling ~4.4s — see
...
export function ScrollHint({ play = true }: { play?: boolean }) {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, delay: 4.2, ease: easing.outExpo }}
