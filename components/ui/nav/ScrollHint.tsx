 ...
 * beat of the entrance: its delay (3.8s) lands it *after* the CTA cascade has
 * finished (CTAs start at delayChildren 3.2 + stagger, settling ~4.0s — see
...
export function ScrollHint({ play = true }: { play?: boolean }) {
  return (
    <motion.div
      ...
      transition={{ duration: 0.7, delay: 3.8, ease: easing.outExpo }}
