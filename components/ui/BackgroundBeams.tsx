 ...
 * across the section. Mounted in the hero and contact sections only
 * (Direction B "scarcity for impact").
 *
 * Source: https://ui.aceternity.com/components/background-beams
 * Adaptations from upstream:
 *   - `@/lib/utils` → `@/lib/cn` (project convention)
 *   - returns null when reducedMotion is on (Eduardo's environment)
 */
